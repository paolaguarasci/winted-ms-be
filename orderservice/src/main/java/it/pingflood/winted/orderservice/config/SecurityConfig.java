...
import it.pingflood.winted.orderservice.data.dto.RolesDTO;
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    return http.csrf().disable()
      .authorizeHttpRequests(auth -> auth
        .requestMatchers(HttpMethod.GET, "/api/v1/order/v3/api-docs", "/api/v1/order/v3/api-docs/**", "/api/v1/order/webjars/swagger-ui/index.html", "/order/v3/api-docs")
        .permitAll()
        .requestMatchers("/api/v1/order", "/api/v1/order/**")
